...
function selectPlan(vehicleType) {
    ...
    const planOptions = `
        <form >
            <label><input type="radio" name="plan" value="daily"> Daily: $${vehicle.daily}</label><br>
            <label><input type="radio" name="plan" value="monthly"> Monthly: $${vehicle.monthly}</label><br>
            <label><input type="radio" name="plan" value="yearly"> Yearly: $${vehicle.yearly}</label>
        </form>
    `;
